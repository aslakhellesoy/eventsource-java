 ...
 * under the License.
 */
package com.github.eventsource.client.impl.netty.ssl;
...
public class SslTrustManagerFactory extends TrustManagerFactorySpi {
    private static final Logger logger = LoggerFactory.getLogger(SslTrustManagerFactory.class);
    ...
    private static final TrustManager DUMMY_TRUST_MANAGER = new X509TrustManager() {
        ...
        public void checkClientTrusted(X509Certificate[] chain, String authType) {
            ...
            // as described in SslContextFactory.
